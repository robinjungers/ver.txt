...
GLint Material::m_uCastsLight = 0;
...
void Material::getUniformLocations( Program &program ) {
	...
	m_uCastsLight = glGetUniformLocation( program.getGLId(), "uCastsLight" );
}
...
void Material::sendUniformValues() {
  ...
  glUniform1f(m_uCastsLight, m_castsLight);
}
...
void Material::setLightCasting( bool castsLight ){
