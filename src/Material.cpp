...
Material::Material(vec3 diffuseColor, vec3 specularColor, int shininess): m_diffuseColor(diffuseColor), m_specularColor(specularColor), m_shininess(shininess)
{
...
void Material::sendUniformValues(Program &program){
